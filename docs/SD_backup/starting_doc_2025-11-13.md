...
- **⭐ V5.1 Query Datasets** → [`V5.1_QUERY_DATASETS.md`](V5.1_QUERY_DATASETS.md) - **254k papers (2011-mid2025)**
- **⭐ EPMC Query V5.1** → [`EPMC_QUERY_V5_OPTIMIZATION.md`](EPMC_QUERY_V5_OPTIMIZATION.md) - **Query development & validation**
