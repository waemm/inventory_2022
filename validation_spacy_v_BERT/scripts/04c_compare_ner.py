...
# Input files
V2_NER_RESULTS = NER_DIR / "v2_ner_results.csv"
SPACY_NER_RESULTS = NER_DIR / "spacy_ner_results.csv"

# Output files
OUTPUT_CSV = NER_DIR / "ner_comparison.csv"
OUTPUT_REPORT = NER_DIR / "ner_comparison_report.md"
